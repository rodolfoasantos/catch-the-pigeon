...
public class Stage3 extends Stage implements View.OnClickListener{
	...
	protected void nextStage() {
		...
		String[] person_level = {select,"4",Integer.toString(profile.getScore())};
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
	    ...
	    if ((keyCode == KeyEvent.KEYCODE_BACK)) {
	    	dialog = new Dialog(Stage3.this, android.R.style.Theme_Translucent);
