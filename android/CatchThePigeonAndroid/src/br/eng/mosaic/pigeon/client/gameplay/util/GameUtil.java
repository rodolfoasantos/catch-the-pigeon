		...
		for (int i = 0; i < amount; i++) {			
			...
			switch (r.nextInt(4)) {			
				case 0:
					...
					bads.add(new BadPigeon( posAnim, cameraHeight, texture, 1));
					break;
				case 1:
					bads.add(new BadPigeon( cameraWidth, ((int)(Math.random() * cameraHeight)), texture, 1));
					break;
				case 2:
					posAnim = ((int)(Math.random() * cameraWidth));
					bads.add(new BadPigeon(((int)(Math.random() * cameraWidth)), 0, texture, 1));
					break;
				case 3:
