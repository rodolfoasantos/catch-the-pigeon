...
public class NanoHTTPD {
	...
	/*
	 * finish extension by rafa.rocha 
	 */
	...
	public static void main(String[] args) {
		System.out
				.println("NanoHTTPD 1.21 (C) 2001,2005-2011 Jarno Elonen and (C) 2010 Konstantinos Togias\n"
	...
	private class HTTPSession implements Runnable {
		...
		private void decodeMultipartData(String boundary, byte[] fbuf,
				...
				throws InterruptedException {
			try {
				int[] bpositions = getBoundaryPositions(fbuf, boundary
						.getBytes());
				int boundarycount = 1;
